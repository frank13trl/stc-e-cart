...
$get_admin = "select * from seller where Seller_id='$seller_session'";

$run_admin = mysqli_query($con,$get_admin);

$row_admin = mysqli_fetch_array($run_admin);

$admin_id = $row_admin['Seller_id'];

$admin_name = $row_admin['Seller_name'];

$admin_email = $row_admin['Seller_email'];

//$admin_image = $row_admin['Seller_image'];

$admin_country = $row_admin['Seller_address'];

//$admin_job = $row_admin['Seller_job'];

$admin_contact = $row_admin['Seller_contact'];

//$admin_about = $row_admin['Seller_about'];
